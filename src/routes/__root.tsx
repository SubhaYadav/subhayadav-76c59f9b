...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Subha Saubhagya Singh Yadav — AI/ML Engineer" },
      { property: "og:description", content: "Building legacy through code. AI/ML, full-stack, and startup-grade systems." },
